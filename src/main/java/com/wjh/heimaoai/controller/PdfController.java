...
import com.wjh.heimaoai.entity.vo.Result;
import com.wjh.heimaoai.repository.ChatHistoryRepository;
import com.wjh.heimaoai.repository.FileRepository;
...
public class PdfController {
    ...
    public Flux<String> chat(String prompt, String chatId) {
        ...
        return pdfChatClient.prompt()
                ...
                .advisors(a -> a.param(QuestionAnswerAdvisor.FILTER_EXPRESSION, "fileName == '" + file.getFilename() + "'"))
                .stream()
                .content();
    }
    ...
    private void writeToVectorStore(Resource resource) {
        ...
        // 4.写入向量库
        redisVectorStore.add(enrichedDocuments);
    }
}